...
def test_graphrag_input_materializer_copies_only_active_workspace_documents(tmp_path):
    ...
    session.add_all(
        [
            ...
            foreign_document,
            DocumentVersion(
                id="active-version", workspace_id=workspace_id, document_id=active_document.id,
                version_number=1, source_hash="active-source", source_path="uploads/active.md",
                normalized_path="normalized/active.md", source_filename="active.md", size_bytes=1,
            ...
            DocumentVersion(
                ...
                version_number=1, source_hash="foreign-source", source_path="uploads/foreign.md",
                normalized_path="normalized/active.md", source_filename="foreign.md", size_bytes=1,
                state="ready", created_at=now,
            ),
        ]
    )
