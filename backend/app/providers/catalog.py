...
DEFAULT_MODELS = (
    ...
    ModelAssignment("semantic_planner_simple", "openai", "gpt-5.6-luna"),
    ModelAssignment("semantic_planner_standard", "openai", "gpt-5.6-luna"),
    ModelAssignment("semantic_planner_complex", "openai", "gpt-5.6-luna"),
