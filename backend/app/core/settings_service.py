...
INDEX_DEPENDENT = {
    ...
    "graphrag_provider",
    "graphrag_model",
    "graphrag_extraction_provider",
    "graphrag_extraction_model",
    "graphrag_claims_provider",
    "graphrag_claims_model",
    "graphrag_claims_enabled",
    "graphrag_community_provider",
    "graphrag_community_model",
    "graphrag_local_provider",
    "graphrag_local_model",
    "graphrag_global_provider",
    "graphrag_global_model",
    "graphrag_drift_provider",
    "graphrag_drift_model",
    "graphrag_drift_n_depth",
    "graphrag_drift_k_followups",
    "graphrag_drift_primer_folds",
    "graphrag_drift_concurrency",
    "graphrag_drift_max_llm_calls",
    "graphrag_query_fallback_to_hybrid",
    "graphrag_query_wait_seconds",
}
PERSISTED_FIELDS = {
    name
